...
# 初回（theme が空）は v_t を正規化して返す`,
        ...
        },
        {
          type: "list",
          items: [
            "<strong>相槌スキップ</strong>：「はい」「なるほど」など定型の相槌や、内容語が 2 語未満の短文はテーマ更新をスキップ（<code>should_skip_theme_update</code>）",
            "<strong>1チャンク1回</strong>：重い文ベクトル化はチャンクあたり高々1回に抑える",
            "<strong>向きで比較</strong>：正規化済みなので、テーマと語のコサイン類似度は純粋に意味の近さを表す",
          ],
        },
        {
          type: "callout",
