...
n1.x += n1.vx;    n1.y += n1.vy;`,
        ...
        },
        {
          type: "cards",
          items: [
            { icon: "🎈", title: "浮力", body: "常に上方向へ働く一定の力。バブルが「浮かんでいる」ように見せる。" },
            { icon: "🧲", title: "求心力", body: "コンテナ中央へ引き寄せ、端や画面外への張り付きを防ぐ。" },
            { icon: "💥", title: "反発力", tag: "ペナルティ法", body: "距離が「半径の和＋余白」を下回ると、食い込み深さに比例した力で互いを押し出す。重なりが自然に解消される。" },
          ],
        },
        {
          type: "callout",
